...
const BG_OPTIONS = [
  ...
  { value: 'elementary', label: 'Classroom' },
  { value: 'middleschool', label: 'School Hallway' },
  { value: 'highschool', label: 'Cafeteria' },
  { value: 'college', label: 'Dorm Room' },
  { value: 'job', label: 'Office' },
  { value: 'nasa', label: 'Mission Control' },
  { value: 'rocket', label: 'Launch Pad' },
  { value: 'moon', label: 'Lunar Surface' },
