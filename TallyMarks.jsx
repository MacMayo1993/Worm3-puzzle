...
const TallyMarks = ({ flips, radius, origColor }) => {
  ...
  // Cap visual tallies at 10 (5 full) to limit Line component count at large sizes.
  // Higher counts show the count as text instead.
  const cappedFlips = Math.min(flips, 10);
  const halfCycles = cappedFlips;
